...
class NTM(nn.Module):
    ...
    def __init__(self, num_inputs, num_outputs, controller, memory, heads, device):
        """Initialize the NTM.
        ...
        self.fc = nn.Linear(self.controller_size + self.num_read_heads * self.M, num_outputs).to(device)
        self.device = device
